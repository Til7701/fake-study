...
public class StudyFactory2026 extends StudyFactory {
    ...
    public Study create() {
        ...
        correlationCat("E", "Preferierter Kakaoanteil (in Prozent)", "C")
                .missingPercentage(fromDiff(defaultMissingBase, defaultMissingDiff).doubleValue())
                .missingValue(-1d)
        ...
        numberCat("I", "Bissfeste der Schokolade bei BAR (Einheit mBar)")
                .missingPercentage(fromDiff(defaultMissingBase, defaultMissingDiff).doubleValue())
                .missingValue(999d)
        ...
        numberCat("L", "Gewicht der Schokolade bei BAR (Einheit g)")
                .missingPercentage(fromDiff(defaultMissingBase, defaultMissingDiff).doubleValue())
                .missingValue(-1d)
